...
"""autogenerated by genpy from jerky_mov/move_arm_jointsAction.msg. Do not edit."""
import sys
...
class move_arm_jointsAction(genpy.Message):
  _md5sum = "0f46568050ca417603f6676e64b7a0e5"
  _type = "jerky_mov/move_arm_jointsAction"
...
"""
  ...
  _slot_types = ['jerky_mov/move_arm_jointsActionGoal','jerky_mov/move_arm_jointsActionResult','jerky_mov/move_arm_jointsActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(move_arm_jointsAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = jerky_mov.msg.move_arm_jointsActionGoal()
      if self.action_result is None:
        self.action_result = jerky_mov.msg.move_arm_jointsActionResult()
      if self.action_feedback is None:
        self.action_feedback = jerky_mov.msg.move_arm_jointsActionFeedback()
    else:
      self.action_goal = jerky_mov.msg.move_arm_jointsActionGoal()
      self.action_result = jerky_mov.msg.move_arm_jointsActionResult()
      self.action_feedback = jerky_mov.msg.move_arm_jointsActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.joints:
        _v1 = val1.header
      ...
      _x = self
      buff.write(_struct_2B3I.pack(_x.action_goal.goal.type, _x.action_goal.goal.wait, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_result.result.complete, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.action_goal.goal.joints.append(val1)
      _x = self
      start = end
      end += 14
      (_x.action_goal.goal.type, _x.action_goal.goal.wait, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_2B3I.unpack(str[start:end])
      self.action_goal.goal.wait = bool(self.action_goal.goal.wait)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.complete, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
