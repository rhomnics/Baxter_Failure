...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'failure_examples' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rhomni/bax_ws/bax_local/install/${idir}'.  Ask the maintainer 'rhomni <rhomni@todo.todo>' to fix it.")
    endif()
